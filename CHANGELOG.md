...
- **cli:** handle empty input in test mode. Add early return for empty input in test mode. Prevents parse error and pause in tests. Fixes CI test failure on Linux ([3a82f71](https://github.com/JoShMiQueL/sig-maker/commit/3a82f712f292b27f693c40e19252295f4c1bbd75)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **cli:** remove error print in test mode. Remove eprintln from parse error in test mode to prevent CI failures ([47abf40](https://github.com/JoShMiQueL/sig-maker/commit/47abf4048f713b8061a298bdd9a62b3a092f35aa)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- add commit links and filter all changelog-scope commits ([7f509a2](https://github.com/JoShMiQueL/sig-maker/commit/7f509a279523e395d6ef6f8ca7be811653d92db9)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- rebalance commit_parsers filters ([be242e5](https://github.com/JoShMiQueL/sig-maker/commit/be242e585a59bc05e80a99f1dd4b91987f8e8922)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- ignore non-code changes in CI trigger ([a20b730](https://github.com/JoShMiQueL/sig-maker/commit/a20b730b8970a740bf0e171d90a63cb4f59d1fa0)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- add workflow_dispatch and fix Windows test pattern ([5fa90b1](https://github.com/JoShMiQueL/sig-maker/commit/5fa90b116fbba3ab6816b979c45033bea51a6bdb)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- remove GUI tests from CI ([ff2551e](https://github.com/JoShMiQueL/sig-maker/commit/ff2551eecbed671c29c59e17186cdbcdbd7aab5a)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- use windows-2025-vs2026 to avoid redirect notice ([894e0bf](https://github.com/JoShMiQueL/sig-maker/commit/894e0bf7a3c4de541260f3190a030cf7f9160003)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** link version header to GitHub release tag ([b90c12e](https://github.com/JoShMiQueL/sig-maker/commit/b90c12ef5385c72c755e880921bc4671b9706b33)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **gui:** add Tauri GUI with automated release workflow [[#37](https://github.com/JoShMiQueL/sig-maker/pull/37)] by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **release:** add release skill and optimize CI paths ([2958b66](https://github.com/JoShMiQueL/sig-maker/commit/2958b66043dfe3c202faf4e3a8e6beb643abe540)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- remove automated release workflow ([98bb3aa](https://github.com/JoShMiQueL/sig-maker/commit/98bb3aa25e3753ec26caa7b602460d9ba6d9fd96)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- remove release automation scripts ([8e9c751](https://github.com/JoShMiQueL/sig-maker/commit/8e9c751171bba8b5ed5f9aff8b1fd1f08ead03b9)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Fix template errors (deprecated fields, missing release) ([758f338](https://github.com/JoShMiQueL/sig-maker/commit/758f338173433ce20afefdef45af5a800ae20af1)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Filter out bot accounts from contributors ([df74b97](https://github.com/JoShMiQueL/sig-maker/commit/df74b97379e9a43098cec0193fb64db0879e9e90)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Filter bots from New Contributors section in template ([f598cb8](https://github.com/JoShMiQueL/sig-maker/commit/f598cb8fd92125741266e1cfa671278d41ec57c9)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Add spacing between release sections ([1f54d25](https://github.com/JoShMiQueL/sig-maker/commit/1f54d25d3ac67db457d1371bcbcd454d42bfb115)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Improve workflow to prevent PR pile-up ([4293a8e](https://github.com/JoShMiQueL/sig-maker/commit/4293a8e2013a0ab6df8798d95f46967ead9ecdc0)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Fix gh commands in workflow ([d463db0](https://github.com/JoShMiQueL/sig-maker/commit/d463db02d0bf652116992bd1c97dcf4ae0a6a583)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Fix git-cliff installation in composite action ([d73632d](https://github.com/JoShMiQueL/sig-maker/commit/d73632d9a2a85a8a3df9a3e40e45d2daead330fc)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Use find to locate git-cliff binary ([1fe81c1](https://github.com/JoShMiQueL/sig-maker/commit/1fe81c16a8b94f13cbbf8849dc19dfdfdefec213)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Create PR instead of direct push ([1933b1b](https://github.com/JoShMiQueL/sig-maker/commit/1933b1b7b1fdd2e5efd34b75fb050a2ae852ae43)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Remove automatic trigger on push ([cb34db7](https://github.com/JoShMiQueL/sig-maker/commit/cb34db79fcae6a045a67632277c3a7668daf08fb)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Remove [skip ci] from commit message ([0cd8d1d](https://github.com/JoShMiQueL/sig-maker/commit/0cd8d1d15995e87979100084e8f6416d49a5e7a3)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Use find to locate git-cliff binary ([be3344a](https://github.com/JoShMiQueL/sig-maker/commit/be3344afc58272edae5359428dff22b221430037)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Pass admin token as input from workflow ([9d4c68e](https://github.com/JoShMiQueL/sig-maker/commit/9d4c68e69bde50fb06013e11ae72a17cf6f6a701)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Add New Contributors section ([5449986](https://github.com/JoShMiQueL/sig-maker/commit/5449986a52d7df3bae618265ec33d95895b161d8)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Add Contributors section and Full Changelog link ([1497c29](https://github.com/JoShMiQueL/sig-maker/commit/1497c29f6327f21379ba0d940fe1c8dc95995f3c)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** List all PRs per contributor in Contributors section ([319452c](https://github.com/JoShMiQueL/sig-maker/commit/319452cb73ec55998235e6d90d03e6289e8e9f39)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Add manual changelog workflow ([b07e956](https://github.com/JoShMiQueL/sig-maker/commit/b07e95614c4ef3eab8bf720d1c8d6792fab51f1f)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Add auto-merge to changelog workflow ([b808873](https://github.com/JoShMiQueL/sig-maker/commit/b808873d1ee2c67defa3bc67ff37a5e73511adaf)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **changelog:** Add auto-merge without CI wait ([27a4c7d](https://github.com/JoShMiQueL/sig-maker/commit/27a4c7dfdee5c883153ad7405b94f30c55a38737)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Create reusable action for changelog generation ([5d18d56](https://github.com/JoShMiQueL/sig-maker/commit/5d18d565e6632e46ac9636c8801275b886e81dc5)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Add admin token for bypassing branch protection ([8da8637](https://github.com/JoShMiQueL/sig-maker/commit/8da8637be4841cf65ff2d02b6c4c4b9d813c7808)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Add [skip ci] to commit message ([14ef148](https://github.com/JoShMiQueL/sig-maker/commit/14ef148479ea6555691a13a35ba94460418c7c18)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
...
- **deps:** bump actions/stale from 9 to 10 [[#1](https://github.com/JoShMiQueL/sig-maker/pull/1)] by [@dependabot[bot]](https://github.com/dependabot[bot])
...
- **release:** v0.1.1-beta ([0bb0151](https://github.com/JoShMiQueL/sig-maker/commit/0bb0151cefe80a34fb22cc63d45b7bbd2111a91c)) by [@JoShMiQueL](https://github.com/JoShMiQueL)

### Refactoring

- **changelog:** Create composite action to reuse code ([2f3fa32](https://github.com/JoShMiQueL/sig-maker/commit/2f3fa320c6f31da7cf05705b0d61b50e7929b0d2)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
- **changelog:** Use secret directly in action ([4d1b0c3](https://github.com/JoShMiQueL/sig-maker/commit/4d1b0c39bace4c7f6608958317763213f0d1def2)) by [@JoShMiQueL](https://github.com/JoShMiQueL)
